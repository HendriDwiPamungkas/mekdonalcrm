...
@section('caption', 'List of Quotations')

@section('title', 'List of Quotations')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('finances/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Add Quotations</button>
            </a>
            <br><br>
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-code-fork" aria-hidden="true"></i> List of Quotations
                </div>
