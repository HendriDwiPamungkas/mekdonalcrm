...
@section('caption', 'List of Customers')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('clients/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Add Customers</button>
            </a>
            <br><br>
            <!-- Advanced Tables -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-users" aria-hidden="true"></i> List of Customers
                    </div>
