    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('tasks/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Add Leads</button>
            </a>
            <br>
            <!-- Advanced Tables -->
            <h4 class="page-header">
                <i class="fa fa-code-fork" aria-hidden="true"></i> List of Leads
            </h4>
