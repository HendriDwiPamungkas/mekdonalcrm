...
@section('title', 'Welcome in Mekdonal CRM')

@section('caption', 'Welcome in Mekdonal CRM')
    ...
    <div class="row">
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-green">
                    ...
                    <h3 style="padding:8px;font-size:18px">Customers: {{ $countClients }}
                        ({{ $deactivatedClients }})
                    </h3>
                </div>
        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-blue">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">Sales: {{ $countSales }}
        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-red">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">Quotations: {{ $countFinances }}
        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-brown">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">Products: {{ $countDeals }}
                        ({{ $deactivatedDeals }})
                    </h3>
                </div>
...
<div class="text-center">
    <img src="LOGO.png" width="80%" class="img-fluid" alt="Responsive image">
</div>
